...
dinosaurOne.roar = () => "RAWERSRARARWERSARARARRRR!"
...
zooAnimals.forEach((animal) => {displayNames.push(`Name: ${animal.animal_name}, ${animal.scientific_name}.`)});
...
populationTotal= zooAnimals.reduce((currentTotal, animal) => {
  return currentTotal += animal.population;
},0);
